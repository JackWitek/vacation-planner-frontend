    ...
    <div class=" justify-between  flex  items-center">
      <div class="flex flex-auto  items-center ">
        <svg
          ...
          width="95.000000pt"
          height="48.000000pt"
          viewBox="0 0 955.000000 980.000000"
        ...
        >
          ...
          >
            <path
              d="M4570 12790 c0 -3 9 -31 20 -61 65 -188 53 -370 -55 -774 -68 -254
...
-41 0 -4 -106 60 -119 72 -16 15 18 -2 64 -31z"
        ...
        <a
          href="/"
          class="uppercase display-1 font-mono pl-14 font-semibold no-underline text-indigo-dark hover:text-indigo-darker"
          >Vacation Planner</a
        >
      </div>
      <div class="px-5">
        ...
        <router-link
          to="/"
          v-model="updateFix"
          class="link-grey pxl-40 no-underline"
          v-if="!signedIn()"
          >Sign In</router-link
        >
        <router-link
          to="/signup"
          class="link-grey px-2 no-underline"
          v-if="!signedIn()"
          >Sign Up</router-link
        >
        <a
  ...
  methods: {
    ...
    signOut() {
      this.$http.secured
        ...
        .catch(error => this.setError(error, "Error signing out"));
    }
  }
};
</script>
